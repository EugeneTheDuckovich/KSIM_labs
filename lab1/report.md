...
5. Стабільність екосистеми - період часу, протягом якого кролики існують;
6. Фаза циклу "хижак-жертва" - момент, коли кількість кроликів перевищує кількість трави, що свідчить про перехід до наступної фази циклу.
...
![Вплив початкової кількості кроликів](experiment1.png)
...
![Вплив швидкості росту трави на популяції](experiment2.png)
...
![Вплив бур'янів на популяції кроликів та трави](experiment3.png)